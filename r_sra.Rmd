...
```{r}
sra_dir <- '~/sra_download'
dir.create(sra_dir,showWarnings=FALSE)

sra_fns <- c("SRR1635768","SRR1566401")
...
dir.create(sra_output,showWarnings=FALSE)

sra_files <- list.files(sra_dir,full.names=TRUE)

for (i in seq_along(fastq_files)) system2('fastq-dump',args=c(sra_files[i],
                                                              '-O', sra_output,
                                                              '--gzip',
                                                              '--clip',
                                                              '--skip-technical',

...
### Method 1: Using rosenclassGrp Shared R Library
...
data_dir=/home/sw424/genStats/dada2/moving_pictures
...
scratch_path <- '/scratch/sw424/moving_pictures'
...
Finally, we'll create the submission script. **Note the following change that allows you to use the pacakges in the shared folder.** In this submissions script, immediately after you load your modules, you must add the line:
...
data_dir=/home/sw424/genStats/dada2
work_dir=/scratch/sw424/moving_pictures
